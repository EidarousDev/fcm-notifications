...
public class NotificationUtils {
    ...
    public static void NotifyUserComment(Context context) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context,context.getString(R.string.default_notification_channel_id))
                ...
                .setContentTitle(context.getString(R.string.comment_notification_title))
                .setContentText(context.getString(R.string.comment_notification_body))
                .setStyle(new NotificationCompat.BigTextStyle().bigText(
                        context.getString(R.string.comment_notification_body)))
    ...
    private static PendingIntent contentIntent(Context context) {
        ...
        Intent startActivityIntent = new Intent(context, NotificationsFragment.class);
